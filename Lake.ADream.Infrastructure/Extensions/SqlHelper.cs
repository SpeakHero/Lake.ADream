...
namespace BookDAL
{
    ...
    public sealed class SqlHelper
    {
        ...
        private static void PrepareCommand(SqlCommand command, SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection)
        {
            ...
            if (transaction != null)
            {
                if (transaction.Connection == null) throw new ArgumentException("交易回滚或提交，请提供一个开放的交易。", nameof(transaction));
        ...
        {
            return ConfigHelper.GetJsonConfig("ConnectionStrings").GetValue("DefaultConnection");
        }
        /// <summary> 
        /// 一个有效的数据库连接对象 
        /// </summary> 
        ...
        public static int ExecuteNonQuery(SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("交易回滚或提交，请提供一个开放的交易。", nameof(transaction));
    ...
    public sealed class SqlHelperParameterCache
    {
        ...
        private static SqlParameter[] DiscoverSpParameterSet(SqlConnection connection, string spName, bool includeReturnValueParameter)
        {
            ...
            DbCommand cmd = new SqlCommand(spName, connection);
            cmd.CommandType = CommandType.StoredProcedure;
